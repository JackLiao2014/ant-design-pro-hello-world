...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/Users/jackliao/ant-design/ant-design-pro-hello-world/node_modules/_react-intl@3.12.1@react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/Users/jackliao/ant-design/ant-design-pro-hello-world/node_modules/_warning@4.0.3@warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/jackliao/ant-design/ant-design-pro-hello-world/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'id-ID': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/jackliao/ant-design/ant-design-pro-hello-world/src/locales/id-ID.ts')),
    },
    locale: 'id-ID',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/jackliao/ant-design/ant-design-pro-hello-world/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/jackliao/ant-design/ant-design-pro-hello-world/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/jackliao/ant-design/ant-design-pro-hello-world/src/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
